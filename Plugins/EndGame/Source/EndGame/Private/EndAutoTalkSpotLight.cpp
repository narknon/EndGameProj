...
AEnSpotLight::AEnSpotLight(const FObjectInitializer& ObjectInitializer)
...
#if WITH_EDITOR
void AEnSpotLight::LoadedFromAnotherClass(const FName& OldClassName)
{
...
void AEnSpotLight::SetInnerConeAngle(float NewInnerConeAngle)
{
	SpotLightComponent->SetInnerConeAngle(NewInnerConeAngle);
}

void AEnSpotLight::SetOuterConeAngle(float NewOuterConeAngle)
{
...
#if WITH_EDITOR
void AEnSpotLight::EditorApplyScale(const FVector& DeltaScale, const FVector* PivotLocation, bool bAltDown, bool bShiftDown, bool bCtrlDown)
{
...
void AEnSpotLight::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
