...
AEndBattleAIController::AEndBattleAIController() {
    ...
    this->AroundAddDistance = 1;
    this->RunAroundThreshold = 1;
    this->bWandering = false;
    this->WanderingRange = 1;
    this->WanderingInterval = 1;
    this->WanderingIntervalRand = 1;
    this->bWanderingStrafe = true;
    this->bLockMoveMode = false;
    this->bAcceptMoveAbility = false;
    this->SearchMoveTime = 1;
    ...
    this->UcpcDifHeightAutoRange = 1;
    this->ActorChaseEndDistance = 1;
    this->ActorChaseEndDifHeight = 1;
    ...
    this->CharaDistance = 1;
    this->CharaDistanceQuantity = 1;
    this->bCanRequestActionAtSync = true;
    this->bForcePositionAngle = false;
    this->ForcePositionAngleRange = 1;
    this->WhiteListGroup = 0;
    this->BlackListGroup = 0;
    this->DefenceAreaGroup = 0;
    this->AirPointGroup = 0;
    this->ChaseGroup = 0;
    this->FearThreshold = 1;
    this->DamageSourceEntryThreshold = 1;
    this->CanReachRange = 1;
    ...
    this->AerialFunnelFixTime = 1;
    this->bAeriaDecoyMode = false;
    this->AerialGoalRadius = 1;
    this->AerialUsePath = true;
    this->AerialSplineRotateMargin = 1;
    this->AerialSplineRotateSpeed = 1;
    this->AerialSplineAccSpeed = 1;
    this->bAerialSplineRotatePitch = true;
    this->bAerialSplineRotateRoll = true;
    this->bAerialSplineRun = false;
    this->bAerialSplineThreshold = 1;
    this->bAerialSplineActive = true;
    this->bAerialSplineApproachFront = false;
    this->bAerialSplineApproachDistanceQuantity = 1;
    this->bAerialSplineApproachQuantity = 1;
    ...
    this->AerialSplineOverrideYawAngle = 1;
    this->bAerialSplineOverridePitch = false;
    this->AerialSplineOverridePitchAngle = 1;
    this->AerialSplineTurn = true;
    this->bAerialSplineAutoAdjust = true;
    this->AerialRotateSpeed = 1;
    this->AerialHoveringRange = 1;
    this->AerialHoveringInterval = 1;
    this->AerialHoveringIntervalRand = 1;
    ...
    this->secondsIntervalATBAttack_ = 1;
